...
- **Using PoDLE in LN:** as described in [Newsletter #83][news83
  ...
  ([PoDLE][]) which are used by JoinMarket to avoid the same type of
  costless UTXO disclosure attacks.
    ...
    it from being maliciously reused with other nodes.  Gibson was also
    able to describe some of the design decisions that went into
