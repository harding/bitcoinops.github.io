...
Kalle Alm that implements a new kind of Bitcoin test network. Signet has since
been merged (see [Newsletter #117][news117 signet]) for the upcoming v0.21
release.
...
{% include functions/details-list.md
  q0="What is signet?"
  a0="Signet is defined by [BIP325][bip325] and is both a mechanism to build
      stable, centralized, custom proof-of-work networks that anyone may run and
  ...
  q1="Is signet intended to replace existing Bitcoin testing networks like
      testnet or regtest?"
  a1="They are complementary. Signet was conceived as an centralized, stable
      improvement for cases where the current testnet isn't ideal."

  q2="What problems do we have with the current testnet?"
  a2="Testnet is unreliable due to a high variance of hashrate and block
      emission (blocks tend to come in widely spaced, unpredictable clusters),
      disruptive reorgs, and a skewed incentive model: testnet coins don't have
  ...
  a5="Difficulty is set by the `nBits` parameter, a custom compressed
      representation of the target whose human-readable representation is
      difficulty."
